...
class _PaymentVouchersScreenState extends State<PaymentVouchersScreen> {
    ...
    return Scaffold(
      ...
      body: Consumer<PaymentVoucherProvider>(
        builder: (context, provider, child) {
          ...
          final filteredVouchers = _getFilteredVouchers(provider.vouchers);
            ...
            child: Column(
              ...
              children: [
                Padding(
                  ...
                  child: _buildHeader(provider, filteredVouchers.length),
                ),
  ...
  Widget _buildHeader(PaymentVoucherProvider provider, int filteredCount) {
    final cs = Theme.of(context).colorScheme;
    final isMobile = ResponsiveHelper.isMobile(context);
    final submittedCount = provider.submittedVouchers.length;

    return Container(
      padding: EdgeInsets.symmetric(horizontal: isMobile ? 16 : 22, vertical: 20),
      decoration: BoxDecoration(
      ...
      child: LayoutBuilder(
        builder: (context, constraints) {
          ...
          final pills = [
            ...
            _buildHeaderPill('Submitted', '$submittedCount'),
          ...
          if (isCompact) {
            return Column(
              ...
              children: [
                ...
                Text(
                  'Paid: ${AppConstants.currencySymbol}${NumberFormat('#,##0.00').format(provider.totalPaidAmount)} · ${provider.vouchers.length} vouchers',
                  style: TextStyle(
